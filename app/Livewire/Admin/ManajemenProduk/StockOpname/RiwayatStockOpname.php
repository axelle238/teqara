...
namespace App\Livewire\Admin\ManajemenProduk\StockOpname;
...
class RiwayatStockOpname extends Component
{
    ...
    public function mulaiSesiBaru()
    {
        ...
        return redirect()->route('admin.produk.so.detail', $so->id);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.manajemen-produk.stock-opname.riwayat-stock-opname', [
            'riwayat' => $riwayat,
            'stats' => [
