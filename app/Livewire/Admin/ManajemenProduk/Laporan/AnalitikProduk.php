...
namespace App\Livewire\Admin\ManajemenProduk\Laporan;
...
class AnalitikProduk extends Component
{
    ...
    public function render()
    {
        ...
        $topProduk = DetailPesanan::select('produk_id', DB::raw('SUM(jumlah) as total_terjual'), DB::raw('SUM(subtotal) as total_omset'))
            ->where('created_at', '>=', $this->waktuMulai)
            ->groupBy('produk_id')
        ...
        return view('livewire.admin.manajemen-produk.laporan.analitik-produk', [
            'topProduk' => $topProduk,
            'topMargin' => $topMargin,
