...
class ManajemenStruktur extends Component
{
    ...
    public function simpanDept()
    {
        ...
        LogHelper::catat('create_dept', $this->inputNamaDept, "Admin menambah departemen baru: {$this->inputNamaDept}");
    ...
    public function simpanJabatan()
    {
        ...
        LogHelper::catat('create_jabatan', $this->inputNamaJabatan, "Admin menambah jabatan baru: {$this->inputNamaJabatan}");
    ...
    {
        return view('livewire.admin.h-r-d.manajemen-struktur', [
