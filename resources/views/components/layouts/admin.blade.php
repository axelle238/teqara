            ...
            >
                ...
                <div class="space-y-1">
                    ...
                    <div x-show="aktif === 'produk'" x-cloak x-transition class="pl-12 space-y-1 py-2 border-l-2 border-emerald-100 ml-9">
                        ...
                        <a href="{{ route('admin.produk.pembelian.riwayat') }}" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-[10px] font-bold {{ request()->is('admin/produk/pembelian*') ? 'text-emerald-700 bg-emerald-50' : 'text-slate-400 hover:text-emerald-600' }} rounded-xl transition uppercase tracking-widest">PEMBELIAN STOK (PO)</a>
                        <a href="{{ route('admin.produk.promo.flash-sale') }}" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-[10px] font-bold {{ request()->is('admin/produk/promo*') ? 'text-emerald-700 bg-emerald-50' : 'text-slate-400 hover:text-emerald-600' }} rounded-xl transition uppercase tracking-widest">FLASH SALE (PROMO)</a>
                        <a href="{{ route('admin.produk.garansi') }}" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-[10px] font-bold {{ request()->is('admin/produk/garansi*') ? 'text-emerald-700 bg-emerald-50' : 'text-slate-400 hover:text-emerald-600' }} rounded-xl transition uppercase tracking-widest">GARANSI & RETUR (RMA)</a>
                        ...
                        <a href="{{ route('admin.produk.so.riwayat') }}" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-[10px] font-bold {{ request()->is('admin/produk/stock-opname*') ? 'text-emerald-700 bg-emerald-50' : 'text-slate-400 hover:text-emerald-600' }} rounded-xl transition uppercase tracking-widest">STOCK OPNAME (SO)</a>
                        <a href="{{ route('admin.produk.seri') }}" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-[10px] font-bold {{ request()->is('admin/produk/seri') ? 'text-emerald-700 bg-emerald-50' : 'text-slate-400 hover:text-emerald-600' }} rounded-xl transition uppercase tracking-widest">PELACAKAN SERI (IMEI)</a>
                        <a href="{{ route('admin.produk.laporan') }}" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-[10px] font-bold {{ request()->is('admin/produk/laporan*') ? 'text-emerald-700 bg-emerald-50' : 'text-slate-400 hover:text-emerald-600' }} rounded-xl transition uppercase tracking-widest">LAPORAN ANALITIK</a>
