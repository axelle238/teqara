                    ...
                    @auth
                        ...
                        <div class="relative" x-data="{ userOpen: false }">
                            ...
                            <div x-show="userOpen" @click.away="userOpen = false" class="absolute top-full right-0 mt-3 w-64 bg-white/95 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/20 p-2 z-50 animate-in fade-in slide-in-from-top-2 ring-1 ring-slate-900/5">
                                ...
                                <div class="space-y-1">
                                    <a href="{{ route('customer.dashboard') }}" wire:navigate class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-50 text-slate-600 hover:text-indigo-600 transition-colors text-xs font-bold uppercase tracking-wide group">
                                        <i class="fa-solid fa-gauge-high w-5 text-center group-hover:scale-110 transition-transform"></i> Dashboard
                                    </a>
                ...
                @auth
                    <div class="mt-8 pt-8 border-t border-slate-100">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="{{ route('customer.dashboard') }}" class="px-4 py-3 rounded-xl bg-indigo-600 text-white text-xs font-bold text-center uppercase tracking-wide">Dashboard</a>
