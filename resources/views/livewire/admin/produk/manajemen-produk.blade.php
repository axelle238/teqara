<div class="space-y-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
        <div class="bg-white p-8 rounded-[48px] shadow-sm border border-indigo-50 flex items-center gap-6 group hover:shadow-xl transition-all duration-500">
            ...
            <div>
                ...
                <p class="text-3xl font-black text-slate-900 tracking-tighter">{{ $produk->total() }} <span class="text-xs text-slate-400 font-bold uppercase">SKU</span></p>
            </div>
        </div>
        <div class="bg-white p-8 rounded-[48px] shadow-sm border border-indigo-50 flex items-center gap-6 group hover:shadow-xl transition-all duration-500">
    ...
    <!-- Tabel Data & Filter: No Slate-900 -->
        ...
        <div class="p-8 border-b border-indigo-50 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-50/30">
            <div class="relative w-full md:w-96 group">
                <input 
                    ...
                    type="text" 
                    placeholder="Cari model atau SKU..." 
                    ...
                    <tr class="group hover:bg-indigo-50/20 transition-colors duration-300">
                        <td class="px-10 py-6">
                            <div class="flex items-center gap-6">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">SKU: {{ $p->sku }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-6">
                        ...
                        <td class="px-10 py-6 text-right">
                            <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-x-0 translate-x-4">
                                <a href="{{ route('admin.produk.spesifikasi', $p->id) }}" wire:navigate class="p-3 bg-white border border-indigo-100 text-indigo-400 hover:text-white hover:bg-indigo-600 rounded-2xl transition-all shadow-sm group/btn">
        ...
        <form wire:submit.prevent="simpan" class="space-y-10 p-2">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">SKU / Kode Unik</label>
                        <input wire:model="sku" type="text" class="w-full rounded-2xl border-none bg-indigo-50/50 px-6 py-4 text-sm font-black text-indigo-600 focus:ring-2 focus:ring-indigo-500 placeholder:text-slate-300 transition-all uppercase" placeholder="TEQ-SKU-001">
                        @error('sku') <span class="text-rose-500 text-[9px] font-black uppercase tracking-widest mt-1 px-1">{{ $message }}</span> @enderror
                    </div>
                    <div class="space-y-2">
