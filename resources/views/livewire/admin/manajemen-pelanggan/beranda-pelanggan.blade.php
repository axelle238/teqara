<div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.pelanggan.daftar') }}" wire:navigate class="px-5 py-3 bg-indigo-600 text-white rounded-xl text-sm font-bold shadow-lg hover:bg-indigo-700 transition-all">
