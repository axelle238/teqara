<div class="max-w-5xl mx-auto pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.logistik.pemasok') }}" wire:navigate class="px-6 py-3 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 transition-all shadow-sm">
                Batal
            </a>
