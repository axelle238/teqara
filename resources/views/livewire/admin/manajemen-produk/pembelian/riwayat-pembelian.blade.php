<div class="space-y-12 pb-32">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-8 bg-white p-10 rounded-[48px] shadow-sm border border-indigo-50">
        ...
        <a href="{{ route('admin.produk.pembelian.baru') }}" wire:navigate class="px-8 py-4 bg-indigo-600 text-white rounded-3xl font-black text-xs uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-500/20 flex items-center gap-3">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="group hover:bg-slate-50 transition-all">
                        ...
                        <td class="px-10 py-6 text-right">
                            <a href="{{ route('admin.produk.pembelian.detail', $r->id) }}" wire:navigate class="px-6 py-2 bg-white border border-slate-200 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-600 hover:text-white transition-all shadow-sm">
                                Kelola
                            </a>
                        </td>
                    </tr>
