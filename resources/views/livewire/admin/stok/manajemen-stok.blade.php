<div class="space-y-10 pb-20">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-8 bg-white p-8 rounded-[40px] shadow-sm border border-indigo-50">
        <div class="space-y-2">
            ...
            <p class="text-slate-500 font-medium text-lg">Manajemen pergerakan unit lintas gudang dan kontrol SKU hulu-hilir.</p>
        </div>
        <div class="flex items-center gap-4">
            <div class="relative group">
                <input wire:model.live.debounce.300ms="cari" type="text" placeholder="Cari SKU atau Model..." class="w-72 pl-12 pr-4 py-4 bg-slate-50 border-none rounded-2xl text-sm font-bold text-slate-900 focus:ring-2 focus:ring-emerald-500 shadow-sm transition-all">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="group hover:bg-emerald-50/30 transition-colors duration-300">
                                <td class="px-10 py-6">
                                    ...
                                    <p class="text-[10px] text-slate-400 font-bold uppercase tracking-tighter mt-1">{{ $s->sku }} • <span class="text-indigo-500">{{ $s->kategori?->nama }}</span></p>
                                </td>
                                <td class="px-6 py-6">
