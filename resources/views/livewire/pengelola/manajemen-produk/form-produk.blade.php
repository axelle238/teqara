<div class="max-w-7xl mx-auto pb-20">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <div class="flex gap-3">
            <a href="{{ route('pengelola.produk.katalog') }}" wire:navigate class="px-4 py-2 bg-white border border-slate-300 rounded-xl text-sm font-bold text-slate-700 hover:bg-slate-50 transition">Batal</a>
