<div class="space-y-12 pb-32">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-8 bg-white p-10 rounded-[40px] shadow-sm border border-indigo-50">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('pengelola.produk.katalog') }}" wire:navigate class="px-8 py-4 bg-emerald-600 text-white rounded-3xl font-black text-xs uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-500/20">KELOLA KATALOG</a>
        </div>
    </div>
        ...
        <div class="bg-white rounded-[56px] shadow-sm border border-indigo-50 overflow-hidden">
            ...
            <div class="divide-y divide-indigo-50">
                ...
                <div class="px-10 py-6 flex items-center gap-6 group hover:bg-indigo-50/20 transition-all">
                    ...
                    <a href="{{ route('pengelola.produk.spesifikasi', $p->id) }}" wire:navigate class="p-3 bg-slate-50 text-slate-400 hover:bg-indigo-600 hover:text-white rounded-2xl transition-all">
        ...
        <div class="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-[56px] p-12 text-white shadow-2xl relative overflow-hidden flex flex-col justify-between">
            <div class="relative z-10 space-y-8">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <a href="{{ route('pengelola.kategori') }}" wire:navigate class="flex items-center justify-between p-6 bg-white/10 hover:bg-white/20 border border-white/10 rounded-[32px] transition-all group">
                    ...
                    <a href="{{ route('pengelola.merek') }}" wire:navigate class="flex items-center justify-between p-6 bg-white/10 hover:bg-white/20 border border-white/10 rounded-[32px] transition-all group">
