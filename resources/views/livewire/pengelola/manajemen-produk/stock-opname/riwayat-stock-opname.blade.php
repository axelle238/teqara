                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="group hover:bg-slate-50 transition-all">
                        ...
                        <td class="px-10 py-6 text-right">
                            <a href="{{ route('pengelola.produk.so.detail', $r->id) }}" wire:navigate class="px-6 py-2 bg-white border border-indigo-100 text-indigo-600 hover:bg-indigo-600 hover:text-white rounded-xl text-[10px] font-black uppercase tracking-widest transition-all shadow-sm">
                                Detail Audit
                            </a>
                        </td>
                    </tr>
