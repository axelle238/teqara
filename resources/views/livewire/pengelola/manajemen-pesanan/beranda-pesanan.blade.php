<div class="space-y-12 pb-32">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-8 bg-white p-10 rounded-[40px] shadow-sm border border-indigo-50">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('pengelola.pesanan.daftar') }}" wire:navigate class="px-8 py-4 bg-amber-500 text-white rounded-3xl font-black text-xs uppercase tracking-widest hover:bg-amber-600 transition-all shadow-xl shadow-amber-500/20">DAFTAR PESANAN</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-[56px] shadow-sm border border-indigo-50 overflow-hidden">
        ...
        <div class="divide-y divide-indigo-50">
            ...
            <div class="px-10 py-6 flex items-center gap-8 group hover:bg-indigo-50/20 transition-all">
                ...
                <a href="{{ route('pengelola.pesanan.detail', $p->id) }}" wire:navigate class="p-3 bg-white border border-indigo-100 text-indigo-400 hover:text-white hover:bg-indigo-600 rounded-2xl transition-all shadow-sm">
