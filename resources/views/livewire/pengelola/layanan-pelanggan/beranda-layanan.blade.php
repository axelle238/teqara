        ...
        <div class="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-[56px] p-12 text-white shadow-2xl relative overflow-hidden">
            <div class="relative z-10 space-y-10">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <a href="{{ route('pengelola.cs.tiket') }}" wire:navigate class="flex items-center justify-between p-6 bg-white/10 hover:bg-white/20 border border-white/10 rounded-[32px] transition-all group">
                    ...
                    <a href="{{ route('pengelola.pelanggan.ulasan') }}" wire:navigate class="flex items-center justify-between p-6 bg-white/10 hover:bg-white/20 border border-white/10 rounded-[32px] transition-all group">
